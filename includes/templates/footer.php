...
<footer class="section footer-classic footer-classic-dark context-dark">
  <div class="footer-classic-main">
    <div class="container">
      <p class="heading-7">Suscríbete a nuestro Newsletter</p>
      <!-- RD Mailform-->
      ...
      <div class="row row-50">
        <div class="col-lg-5 text-center text-sm-left">
          <article
            ...
            <div class="unit-body">
              <p>Sportland website offers you the latest news about our team as well as updates on our matches and
                other events.</p>
            </div>
          </article>
          <ul class="list-inline list-inline-bordered list-inline-bordered-lg">
            <li>
              <div class="unit unit-horizontal unit-middle">
                ...
                <div class="unit-body">
                  <h6>Contacto</h6><a class="link" href="mailto:#">labanditadelachilean@gmail.com</a>
                </div>
              </div>
            </li>
          </ul>
          <div class="group-md group-middle">
            <div class="group-item">
              <ul class="list-inline list-inline-xs">
                ...
                <li><a class="icon icon-corporate fa fa-tiktok" href="#"></a></li>
                <li><a class="icon icon-corporate fa fa-instagram" href="#"></a></li>
                <li><a class="icon icon-corporate fa fa-play" href="#"></a></li>
              </ul>
            </div><a class="button button-sm button-gray-outline" href="contact-us.html">Contacto</a>
          </div>
        </div>
        <div class="col-lg-7">
          ...
          <div class="row row-20">
            <div class="col-sm-6">
              ...
              <article class="post-classic">
                <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                      src="/images/footer-soccer-post-1-93x87.jpg" alt="" width="93" height="87" /></a></div>
            ...
            <div class="col-sm-6">
              ...
              <article class="post-classic">
                <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                      src="/images/footer-soccer-post-2-93x87.jpg" alt="" width="93" height="87" /></a></div>
                <div class="post-classic-main">
                  <!-- Badge-->
            ...
            <div class="col-sm-6">
              ...
              <article class="post-classic">
                <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                      src="/images/footer-soccer-post-3-93x87.jpg" alt="" width="93" height="87" /></a></div>
                <div class="post-classic-main">
                  <!-- Badge-->
            ...
            <div class="col-sm-6">
              ...
              <article class="post-classic">
                <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                      src="/images/footer-soccer-post-4-93x87.jpg" alt="" width="93" height="87" /></a></div>
                <div class="post-classic-main">
                  <!-- Badge-->
                  <div class="badge badge-primary">The League
                  </div>
  ...
  <div class="footer-classic-aside footer-classic-darken">
    <div class="container">
      <div class="layout-justify">
        <!-- Rights-->
        <p class="rights"><span>La Bandita de la Chilean</span><span>&nbsp;&copy;&nbsp;</span><span
            class="copyright-year"></span><span>.&nbsp;</span><span>Designed by <a
              href="https://www.instagram.com/pvnchiito">Pancho.Graphics</a></span></p>
        <nav class="nav-minimal">
          <ul class="nav-minimal-list">
            <li class="active"><a href="index.html">Inicio</a></li>
            <li><a href="#">Noticias</a></li>
            <li><a href="#">Callamperas</a></li>
