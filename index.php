...
<section class="section swiper-container swiper-slider swiper-classic bg-gray-2" data-loop="true"
  ...
  <div class="swiper-wrapper">
            ...
            <div class="row justify-content-center">
              <div class="col-xl-6">
                <div class="swiper-slide-caption">
                  ...
                  <h4 data-caption-animate="fadeInUp" data-caption-delay="200">like no one else in the united states
            ...
            <div class="row justify-content-end">
              <div class="col-xl-5">
                <div class="swiper-slide-caption">
                  ...
                  <h4 data-caption-animate="fadeInUp" data-caption-delay="200">in Everything Concerning Soccer</h4><a
    ...
    <div class="swiper-slide" data-slide-bg="/images/slider-1-slide-3-1920x671.png">
      <div class="container">
        <div class="row">
          <div class="col-xl-5">
            <div class="swiper-slide-caption">
              <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Bienvenidos a La bandita</h1>
              <h4 data-caption-animate="fadeInUp" data-caption-delay="200">todo el acontecer de <br
                  class="d-none d-xl-block"> la chilean premier league</h4><a class="button button-primary"
                data-caption-animate="fadeInUp" data-caption-delay="300" href="#">Quienes Somos</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row row-50">
      <div class="col-lg-8">
        <div class="main-component">
          ...
          <article class="heading-component">
            <div class="heading-component-inner">
              ...
              </h5><a class="button button-xs button-gray-outline" href="/noticias.html">All news</a>
            </div>
          </article>
          <div class="row row-30">
            <div class="col-md-6">
              ...
              <article class="post-future"><a class="post-future-figure" href="#"><img
                    src="/images/news-2-1-368x287.jpg" alt="" width="368" height="287" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">Sadio mane still makes a difference, sam wilson
                      admits</a></h4>
            ...
            <div class="col-md-6">
              <!-- Post Future-->
              <article class="post-future"><a class="post-future-figure" href="#"><img
                    src="/images/news-2-2-368x287.jpg" alt="" width="368" height="287" /></a>
                <div class="post-future-main">
                  ...
                  <hr />
                  <div class="post-future-text">
                    <p>Robertson, in his first Anfield outing as a Liverpool player, looked assured at left-back...
                    </p>
                  </div>
                  <div class="post-future-footer group-flex group-flex-xs"><a class="button button-gray-outline"
                      href="#">Read more</a>
            ...
            <div class="col-md-6">
              <!-- Post Future-->
              <article class="post-future"><a class="post-future-figure" href="#"><img
                    src="/images/news-2-3-368x287.jpg" alt="" width="368" height="287" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">Pochettino and ‘gaffer’s son’ Rose estranged –
                      reports</a></h4>
                  <div class="post-future-meta">
                    <!-- Badge-->
                    <div class="badge badge-secondary">The Team
                  ...
                  <hr />
                  <div class="post-future-text">
                    <p>Danny Rose and Mauricio Pochettino were once so close that he was nicknamed “the gaffer’s...
                    </p>
                  </div>
                  <div class="post-future-footer group-flex group-flex-xs"><a class="button button-gray-outline"
                      href="#">Read more</a>
            ...
            <div class="col-md-6">
              <!-- Post Future-->
              <article class="post-future"><a class="post-future-figure" href="#"><img
                    src="/images/news-2-4-368x287.jpg" alt="" width="368" height="287" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">Coutinho’s camp: It was all Barca’s fault and we can
                      prove it</a></h4>
                  <div class="post-future-meta">
                    <!-- Badge-->
                    <div class="badge badge-secondary">The Team
            ...
            <div class="col-md-12">
              <!-- Post Gloria-->
              <article class="post-gloria"><img src="/images/post-gloria-1-769x429.jpg" alt="" width="769"
                  height="429" />
                <div class="post-gloria-main">
                  ...
                  <div class="post-gloria-text">
                    ...
                    <p>During this year’s premier league, we are glad to announce that there are new players who
                      are...</p>
            ...
            <div class="col-md-12">
              ...
              <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img
                    src="/images/news-3-1-370x325.jpg" alt="" width="370" height="325" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">Zidane: “We’re not going to change the way we play at
                      the Calderón”</a></h4>
                  <div class="post-future-meta">
                    <!-- Badge-->
                  ...
                  <hr />
                  <div class="post-future-text">
                    <p>Zidane spoke to the media at the Real Madrid City. The Whites coach explained how the team is
                      going in to the second leg of the Champions...</p>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-md-12">
              <!-- Post Future-->
              <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img
                    src="/images/news-3-2-370x325.jpg" alt="" width="370" height="325" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">NFL Will Handle Referee Pete Morelli’s Use of Profanity
                      Internally</a></h4>
                  <div class="post-future-meta">
                    <!-- Badge-->
                    <div class="badge badge-primary">The League
                  ...
                  <hr />
                  <div class="post-future-text">
                    <p>The NFL will internally address referee Pete Morelli's recent microphone gaffe, a league
                      spokesman said, but it does not appear Morelli...</p>
                  </div>
                </div>
              </article>
            </div>
              ...
              <div class="swiper-container swiper-slider post-slider" data-loop="false" data-autoplay="false"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="swiper-slide-caption">
                      <!-- Post Alice-->
                      <article class="post-alice"><img src="/images/post-slide-1-769x397.jpg" alt="" width="769"
                          height="397" />
                  ...
                  <div class="swiper-slide">
                    <div class="swiper-slide-caption">
                      <!-- Post Alice-->
                      <article class="post-alice"><img src="/images/post-slide-2-769x397.jpg" alt="" width="769"
                          height="397" />
                        <div class="post-alice-main">
                          <!-- Badge-->
                          <div class="badge badge-primary">The League
                          </div>
                          <h3 class="post-alice-title"><a href="#">rumors about world soccer championship 2020</a>
                          </h3>
                          <div class="divider"></div>
                          <div class="post-alice-time"><span class="icon mdi mdi-clock"></span>
                            <time datetime="2020">April 15, 2020</time>
            ...
            <div class="col-md-12">
              <!-- Post Future-->
              <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img
                    src="/images/news-3-3-370x325.jpg" alt="" width="370" height="325" /></a>
                <div class="post-future-main">
                  <h4 class="post-future-title"><a href="#">Zidane: “We’re not going to change the way we play at
                      the Calderón”</a></h4>
                  <div class="post-future-meta">
        ...
        <div class="main-component">
          ...
          <article class="heading-component">
            <div class="heading-component-inner">
              <h5 class="heading-component-title">Proximos Partidos
          ...
          <article class="game-result">
            <div class="game-info game-info-creative">
              <p class="game-info-subtitle">Estadio Nacional -
                <time datetime="21:00"> 09:00 PM</time>
              </p>
              <h3 class="game-info-title">Fecha 27 Chilean Premier League</h3>
              <div class="game-info-main">
                <div class="game-info-team game-info-team-first">
                  <figure><img src="/images/team-udechile-92x100.svg" alt="" width="75" height="99" />
                  </figure>
                  <div class="game-result-team-name">U. de Chile</div>
                  <div class="game-result-team-country">Local</div>
                </div>
                <div class="game-info-middle game-info-middle-vertical">
                  <time class="time-big" datetime="2024-12-31"><span class="heading-3">Sab 05</span> Octubre 2024
                  </time>
                  <div class="game-result-divider-wrap"><span class="game-info-team-divider">VS</span></div>
                  <div class="group-sm">
                    <a class="button button-sm button-primary" href="https://www.puntoticket.com/evento/universidad-de-chile-vs-union-la-calera-fecha26-campeonato-itau-2024" target="_blank">Comprar Tickets</a>
                  </div>
                </div>
                <div class="game-info-team game-info-team-second">
                  <figure><img src="/images/team-lacalera-92x100.svg" alt="" width="91" height="91" />
                  </figure>
                  <div class="game-result-team-name">Unión la Calera</div>
                  <div class="game-result-team-country">Visita</div>
                </div>
              </div>
            </div>
            <div class="game-info-countdown">
              <div class="countdown countdown-bordered" data-type="until" data-time="2024-10-13 20:00-03:00" data-format="dhms" data-style="short"></div>
            </div>
          </article>
        </div>
      </div>
        ...
        <aside class="aside-components">
          <div class="aside-component">
            <div class="owl-carousel-outer-navigation-1">
              ...
              <article class="heading-component">
                <div class="heading-component-inner">
                  <h5 class="heading-component-title">Ultimos Resultados
                  </h5>
              ...
              <div class="owl-carousel owl-spacing-1" data-items="1" data-dots="false" data-nav="true"
                ...
                <article class="game-result game-result-creative">
                  <div class="game-result-main-vertical">
                    <div class="game-result-team game-result-team-horizontal game-result-team-first">
                      <figure class="game-result-team-figure"><img src="/images/iquique.svg" alt=""
                          width="35" height="41" />
                      </figure>
                      <div class="game-result-team-title">
                        <div class="game-result-team-name">Iquique</div>
                      ...
                      <div class="game-result-score game-result-score-big game-result-team-win">3<span
                          class="game-result-team-label game-result-team-label-right">Win</span>
                      </div>
                    ...
                    <div class="game-result-team game-result-team-horizontal game-result-team-second">
                      <figure class="game-result-team-figure"><img src="/images/udechile.svg" alt=""
                          width="40" height="32" />
                      </figure>
                      <div class="game-result-team-title">
                        <div class="game-result-team-name">U. de Chile</div>
                  ...
                  <div class="game-result-footer">
                    <ul class="game-result-details">
                      <li>Iquique</li>
                      <li>Estadio Tierra de Campeones</li>
                      <li>
                ...
                <article class="game-result game-result-creative">
                  <div class="game-result-main-vertical">
                    <div class="game-result-team game-result-team-horizontal game-result-team-first">
                      <figure class="game-result-team-figure"><img src="/images/team-bavaria-fc-26x34.png" alt=""
                          width="26" height="34" />
                      </figure>
                      <div class="game-result-team-title">
                    ...
                    <div class="game-result-team game-result-team-horizontal game-result-team-second">
                      <figure class="game-result-team-figure"><img src="/images/team-athletic-33x30.png" alt=""
                          width="33" height="30" />
                      </figure>
                      <div class="game-result-team-title">
          ...
          <div class="aside-component">
            ...
            <article class="heading-component">
              <div class="heading-component-inner">
                <h5 class="heading-component-title">Clasificaciones
                </h5><a class="button button-xs button-gray-outline" href="#">Estadisticas Completas</a>
              </div>
            </article>
            <!-- Table team-->
            <div class="table-custom-responsive">
              <iframe id="sofa-standings-embed-64475-57883" src="https://widgets.sofascore.com/es-ES/embed/tournament/64475/season/57883/standings/Primera%20Division?widgetTitle=Primera%20Division&showCompetitionLogo=true" style=height:963px!important;max-width:768px!important;width:100%!important; frameborder="0" scrolling="no"></iframe>
            </div>
          </div>
          ...
          <div class="aside-component">
            ...
            <article class="heading-component">
              <div class="heading-component-inner">
                <h5 class="heading-component-title">Tabla de Predicciones
                </h5><a class="button button-xs button-gray-outline" href="#">Estadisticas Completas</a>
              </div>
            </article>
            <!-- Table team-->
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="team-inline">
                      <div class="team-figure"><img src="/images/roster-masa-368x286.png" alt="" width="31"
                          height="41" />
                      </div>
                      <div class="team-title">
                        <div class="team-name">U. de Chile</div>
                  ...
                  <tr>
                    <td><span>2</span></td>
                    <td class="team-inline">
                      <div class="team-figure"><img src="/images/colocolo.svg" alt="" width="34"
                          height="34" />
                      </div>
                      <div class="team-title">
                        <div class="team-name">Colo-Colo</div>
                  ...
                  <tr>
                    <td><span>3</span></td>
                    <td class="team-inline">
                      <div class="team-figure"><img src="/images/team-uc-31x41.png" alt="" width="28" height="15" />
                      </div>
                      <div class="team-title">
                        <div class="team-name">U. Católica</div>
                  ...
                  <tr>
                    <td><span>4</span></td>
                    <td class="team-inline">
                      <div class="team-figure"><img src="/images/iquique.svg" alt="" width="35"
                          height="39" />
                      </div>
                      <div class="team-title">
                        <div class="team-name">Iquique</div>
          ...
          <div class="aside-component">
            ...
            <article class="heading-component">
              <div class="heading-component-inner">
                <h5 class="heading-component-title">Siguenos
                </h5>
              </div>
            </article>
            <!-- Buttons Media-->
            <div class="group-sm group-flex"><a class="button-media button-media-facebook" href="#">
                ...
                <p class="button-media-action">Like<span
                  ...
                  class="button-media-icon fa-tiktok"></span>
                ...
                <p class="button-media-action">Follow<span
                    class="icon material-icons-add_circle_outline icon-sm"></span></p><span
                  class="button-media-icon fa-kickstarter-k"></span>
            ...
            <article class="gallery" data-lightgallery="group">
              <div class="row row-10 row-narrow">
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/CRISTOBAL-CAMPOS-POST.png"><img src="/images/gallery-soccer-1-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/gallery-soccer-2-original.jpg"><img src="/images/gallery-soccer-2-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/gallery-soccer-3-original.jpg"><img src="/images/gallery-soccer-3-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/gallery-soccer-4-original.jpg"><img src="/images/gallery-soccer-4-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/gallery-soccer-5-original.jpg"><img src="/images/gallery-soccer-5-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
                <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item"
                    href="/images/gallery-soccer-6-original.jpg"><img src="/images/gallery-soccer-6-212x212.jpg"
                      alt="" />
                    <div class="thumbnail-creative-overlay"></div>
                  </a>
                </div>
          ...
          <div class="aside-component">
            ...
            <article class="heading-component">
              <div class="heading-component-inner">
                <h5 class="heading-component-title">Votaciones La Bandita
                </h5>
              </div>
            </article>
            <div class="block-voting">
              <div class="group-md">
                ...
                <div class="player-voting-item">
                  <div class="player-voting-item-figure"><img src="/images/player-gato-152x144.png" alt=""
                  ...
                  <button class="button button-block button-icon button-icon-left button-primary"
                    type="button"><span class="icon material-icons-thumb_up"></span><span>854 votos</span></button>
                </div>
                <!-- Player Voting Item-->
                <div class="player-voting-item">
                  <div class="player-voting-item-figure"><img src="/images/player-pancho-152x144.png" alt=""
                      width="152" height="144" />
                    <div class="player-number">
                      <p>10</p>
                    </div>
                  ...
                  <button class="button button-block button-icon button-icon-left button-primary"
                    type="button"><span class="icon material-icons-thumb_up"></span><span>436 votos</span></button>
                </div>
                <!-- Player Voting Item-->
                <div class="player-voting-item">
                  <div class="player-voting-item-figure"><img src="/images/player-weli-152x144.png" alt=""
                      width="152" height="144" />
                    <div class="player-number">
                      <p>7</p>
                    </div>
                ...
                <!-- Player Voting Item-->
                <div class="player-voting-item">
                  <div class="player-voting-item-figure"><img src="/images/player-masa-152x144.png" alt=""
                      width="152" height="144" />
                    <div class="player-number">
                      <p>14</p>
                    </div>
